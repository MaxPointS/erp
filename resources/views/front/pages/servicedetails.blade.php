        ...
        <div class="container">
            ...
            <div class="row no-gutters">
                ...
                style="margin-left: 20px" @endif
                    ...
                    <div id="menuservice{{ $service->uuid }}" class="menu-service ">
                        <div class="menu-service-title collapse-toggle" role="tab"
                            data-target="#menu{{ $service->uuid }}Content" data-toggle="collapse" aria-expanded="true">
                        ...
                        <div id="menu{{ $service->uuid }}Content" class="menu-service-content padded collapse show">
                            <div class="row gutters-sm">
                                <div class="col-lg-8 col-12">

                                    <!-- Menu Item `products`.`MenuSort` ASC -->
                                    <div class="menu-item menu-grid-item w-100">
                                    ...
                                    @else
                                        ...
                                        <div id="address_block">
                                            <h4 class="border-bottom pb-4"><i class="ti ti-book ml-3 text-primary"></i>     {{trans('serviceterms.termstitle')}}</h4>
                                            <ul>
                                                @foreach ($service->terms as  $item)
                                                <li>
                                                    <h6 class="mb-1">
                                                        @if (App::islocale('ar'))
                                                        {{$item->arname}}
                                    ...
                                    <div id="address_block">
                                        <h4 class="border-bottom pb-4"><i class="ti ti-map-alt ml-3 text-primary"></i>  {{trans('companyTrans.address')}}</h4>
                                        <ul>
                                            <li>
                                                <h5>
                                                    @if (App::islocale('ar'))
                                                    {{$service->company->araddress}}
                                                @else
                                ...
                                <div style="margin-top: 50px">
                                    <iframe src="{{$service->company->location}}" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
