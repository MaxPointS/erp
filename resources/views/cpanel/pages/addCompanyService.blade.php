                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group text">
                                        ...
                                        <select class="form-control select2 " style="border-radius:0 !important; " value="{{old('company')}}"
                                            ...
                                            @foreach ($companies as $company)
                                                @if (App::islocale('ar'))
                                                    <option value="{{ $company->uuid }}">{{ $company->arname }}</option>
                                                @else
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="arname" id="arname" value="{{old('arname')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <textarea class="form-control" name="ardescription" id ="ardescription" style="resize: none" cols="100"
                                            rows="5" autocomplete="off">{{old('ardescription')}}</textarea>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="number" min="0.000" name="priceBefore" id="priceBefore" value="{{old('priceBefore')}}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="number"min="0.000" name="price" id="price" step="0.001" value="{{old('price')}}" minlength="1.000"
