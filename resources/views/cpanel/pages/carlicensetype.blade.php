    ...
    <div class="row ">
        <div class="col-md-12 ">
            <div class="box" style="border: 0 !important;box-shadow: 0 1px 9px 3px rgba(0,0,0,0.1);">
                <div class="box-header">
                    <h3 class="box-title">{{ trans('carlicensetypeTrans.CreatecarlicensetypeorateTitle') }} </h3>
                </div>
                <div class="box-body ">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <button data-toggle="modal" data-target="#AddNewArea" class="btn btn-success">{{ trans('carlicensetypeTrans.Createcarlicensetypeorate') }} </button>
                        </div>
        ...
        <div class="row ">
            <div class="col-md-12 ">
                <div class="box" style="border: 0 !important;box-shadow: 0 1px 9px 3px rgba(0,0,0,0.1);">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('carlicensetypeTrans.carlicensetypeorateList') }} </h3>
                    </div>
                    <div class="box-body ">
                        <div class="form-row">
                            <div class="table-responsitve">
                                <table id="TableAreas" class="table table-dark table-bordered  table-striped ">
                                    <thead>
                                        <tr>
                                            {{-- <th>#</th> --}}
                                            <th>{{ trans('carlicensetypeTrans.carlicensetypeorateName') }}</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($carlicensetypes as $carlicensetype)
                                            <tr>
                                             <td>
                                                @if (App::islocale('ar'))
                                                    {{$carlicensetypes->arname}}
                                                @else
                                                {{$carlicensetypes->name}}
                                             ...
                                             <td style=" text-align: end" class="text-end">
                                                ...
                                                <button onclick="setModalAttr(this)"  type="button" id="EditBtn"
                                                    ...
                                                    AreaAr="{{ $carlicensetype->arname }}"AreaName="{{ $carlicensetype->name }}" carlicensetypeid="{{ $carlicensetype->id }}" 
                ...
                <form action="">
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-danger">
                            <h5 class="modal-title" id="exampleModalLongTitle">{{ trans('carlicensetypeTrans.DeletecarlicensetypeorateTitle') }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-row">
                                @csrf
                                {{ trans('carlicensetypeTrans.DeletecarlicensetypeorateMessage') }}
                            </div>
                        </div>
    ...
    @section('scriptes')
        ...
        <script>
            ...
            function setModalAttr (param) { 
                    ...
                    // $("#EditAreaSelect").val($(param).attr('carlicensetypeid'))
             }
        </script>
    @endsection
