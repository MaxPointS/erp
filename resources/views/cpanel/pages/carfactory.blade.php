    ...
    <div class="row ">
        <div class="col-md-12 ">
            <div class="box" style="border: 0 !important;box-shadow: 0 1px 9px 3px rgba(0,0,0,0.1);">
                <div class="box-header">
                    <h3 class="box-title">{{ trans('carfactoryTrans.CreatecarfactoryorateTitle') }} </h3>
                </div>
                <div class="box-body ">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <button data-toggle="modal" data-target="#AddNewArea" class="btn btn-success">{{ trans('carfactoryTrans.Createcarfactoryorate') }} </button>
                        </div>
        ...
        <div class="row ">
            <div class="col-md-12 ">
                <div class="box" style="border: 0 !important;box-shadow: 0 1px 9px 3px rgba(0,0,0,0.1);">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('carfactoryTrans.carfactoryorateList') }} </h3>
                    </div>
                    <div class="box-body ">
                        <div class="form-row">
                            <div class="table-responsitve">
                                <table id="TableAreas" class="table table-dark table-bordered  table-striped ">
                                    <thead>
                                        <tr>
                                            {{-- <th>#</th> --}}
                                            <th>{{ trans('carfactoryTrans.carfactoryorateName') }}</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <td style=" text-align: end" class="text-end">
                                                ...
                                                <button onclick="setModalAttr(this)"  type="button" id="EditBtn"
                                                    ...
                                                    AreaAr="{{ $carfactory->arname }}"AreaName="{{ $carfactory->name }}" carfactoryid="{{ $carfactory->id }}" 
                ...
                <form action="">
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-danger">
                            <h5 class="modal-title" id="exampleModalLongTitle">{{ trans('carfactoryTrans.DeletecarfactoryorateTitle') }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-row">
                                @csrf
                                {{ trans('carfactoryTrans.DeletecarfactoryorateMessage') }}
                            </div>
                        </div>
    ...
    @section('scriptes')
        ...
        <script>
            ...
            function setModalAttr (param) { 
                    ...
                    // $("#EditAreaSelect").val($(param).attr('carfactoryid'))
             }
        </script>
    @endsection
