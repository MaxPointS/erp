    ...
    <div class="row ">
        <div class="col-md-12 ">
            <div class="box" style="border: 0 !important;box-shadow: 0 1px 9px 3px rgba(0,0,0,0.1);">
                <div class="box-header">
                    <h3 class="box-title">{{ trans('carfactoryclassTrans.CreatecarfactoryclassorateTitle') }} </h3>
                </div>
                <div class="box-body ">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <button data-toggle="modal" data-target="#AddNewArea" class="btn btn-success">{{ trans('carfactoryclassTrans.Createcarfactoryclassorate') }} </button>
                        </div>
        ...
        <div class="row ">
            <div class="col-md-12 ">
                <div class="box" style="border: 0 !important;box-shadow: 0 1px 9px 3px rgba(0,0,0,0.1);">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('carfactoryclassTrans.carfactoryclassorateList') }} </h3>
                    </div>
                    <div class="box-body ">
                        <div class="form-row">
                            <div class="table-responsitve">
                                <table id="TableAreas" class="table table-dark table-bordered  table-striped ">
                                    <thead>
                                        <tr>
                                            {{-- <th>#</th> --}}
                                            <th>{{ trans('carfactoryclassTrans.carfactoryclassorateName') }}</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($carfactoryclasses as $carfactoryclass)
                                            <tr>
                                             <td>
                                                @if (App::islocale('ar'))
                                                    {{$carfactoryclass->arname}}
                                                @else
                                                {{$carfactoryclass->name}}
                                             ...
                                             <td style=" text-align: end" class="text-end">
                                                ...
                                                <button onclick="setModalAttr(this)"  type="button" id="EditBtn"
                                                    ...
                                                    AreaAr="{{ $carfactoryclass->arname }}"AreaName="{{ $carfactoryclass->name }}" carfactoryclassid="{{ $carfactoryclass->id }}" 
                ...
                <form action="">
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-danger">
                            <h5 class="modal-title" id="exampleModalLongTitle">{{ trans('carfactoryclassTrans.DeletecarfactoryclassorateTitle') }}</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-row">
                                @csrf
                                {{ trans('carfactoryclassTrans.DeletecarfactoryclassorateMessage') }}
                            </div>
                        </div>
    ...
    @section('scriptes')
        ...
        <script>
            ...
            function setModalAttr (param) { 
                    ...
                    // $("#EditAreaSelect").val($(param).attr('carfactoryclassid'))
             }
        </script>
    @endsection
