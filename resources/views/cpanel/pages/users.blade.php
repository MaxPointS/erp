                ...
                <div class="box-body ">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            ...
                            <button data-toggle="modal" data-target="#AddNewArea"
                                class="btn btn-success">{{ trans('governTrans.Creategovernorate') }} </button>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style=" text-align: end" class="text-end">
                                                ...
                                                <button onclick="setModalAttr(this)" type="button" id="EditBtn"
                                                    AreaAr="{{ $user->arname }}"AreaName="{{ $user->name }}"
                                                    governUUID="{{ $user->uuid }}" data-toggle="modal"
                ...
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        <h5 class="modal-title" id="exampleModalLongTitle">
                            {{ trans('governTrans.DeletegovernorateTitle') }}</h5>
